...
export default function AdminConversationsIndex({ company, chatbot, conversations }) {
  return (
    <AdminLayout>
              ...
              {conversations.data.map((conv) => (
                <tr key={conv.id} className="hover:bg-slate-50/50">
                  ...
                  <td className="whitespace-nowrap px-4 py-3 text-right text-sm">
                    <Link
                      href={`/admin/companies/${company.id}/chatbots/${chatbot.id}/conversations/${conv.id}`}

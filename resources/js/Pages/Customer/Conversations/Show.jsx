...
export default function CustomerConversationsShow({ chatbot, conversation }) {
  ...
  return (
    <CustomerLayout>
      ...
      <div className="mb-6 rounded-xl border border-slate-200 bg-white p-4">
        <dl className="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 text-sm">
          <div>
